...
```{r}
library(ShortRead)
fq_reads1 <- readFastq("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_with_adapters.fq")
fq_reads2 <- readFastq("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_with_adapters.fq")
```
...
```{r}
FilteredSeq1 <- 248565/284123*100
FilteredSeq2 <- 223516/273668*100
...
```{R}
   writeFastq(filtered_reads1, "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_processed.fq")
   writeFastq(filtered_reads2, "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_processed.fq")
```

2. Wygeneruj nowe raporty QC dla przetworzonych danych:

```{R}
qa_results1 <- qa("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_with_adapters.fq", type = "fastq")   
qa_results1_processed <- qa( "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_processed.fq", type = "fastq")
report(qa_results1, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read1")
report(qa_results1_processed, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read1_processed")

qa_results2 <- qa("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_with_adapters.fq", type = "fastq")   
qa_results2_processed <- qa("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_processed.fq", type = "fastq")
report(qa_results2, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read2")
report(qa_results2_processed, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read2_processed")
```
...
Długość odczytów sekwencji zdecydowanie się zmniejszyła. 
---
...
Zostało zmodyfikowanych 110400 odczytów. 
...
```{R}
   writeFastq(filtered_reads1, "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_final.fq")
   writeFastq(filtered_reads2, "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_final.fq")
```

2. Wygeneruj ostateczne raporty QC:

```{R}
   qa_results1_final <- qa("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated1_final.fq", type = "fastq")
   report(qa_results1_final, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read1_final")
   
   qa_results2_final <- qa("C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/ecoli_simulated2_final.fq", type = "fastq")
   report(qa_results2_final, dest = "C:/Users/marys/Dropbox/Mój komputer (LAPTOP-6CIOMO42)/Desktop/MAGISTERSKIE/SEMESTR_II/QA_report_read2_final")
```
